...
// Get file contents
CLAUDE_CONTENT=$(Bash("gh api repos/:owner/:repo/contents/ruv-swarm/product/CLAUDE.md --jq '.content' | base64 -d"))
...
[Single Message - Complete Synchronization]:
  ...
  Read("/workspaces/ruv-FANN/ruv-swarm/product/CLAUDE.md")
...
const docSyncPattern = {
  sourceOfTruth: "ruv-swarm/product/CLAUDE.md",
  targets: [
