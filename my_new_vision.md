# Vision on agentic development - update April 2026

I want to play an important role as a director, product visioner  and CTO of my project. I want to be challenged especially on the initial phase, in the beginning. I want to be less bothered for coding, but still want to make important architectural decisions. ALso I want my desicisions not taken for granted but challenged without extremes. I want harness that provide progressive movement towards end result. I believe in tests, review and some of the roles that came from human practices, but not all of them, certain ceremonies should be skipped. I have mostly greenfield projects, but some of them were started years ago and abundant. I don;t want to keep wrong decisions and code, but at the same time I don;t want to throw away baby with water. So, I see that I need good governance support on product definition, architecture, design, tech decisions, testing and review. Would be great to have trace of features and tasks done without extra beaucracy. I want to be able to continue work at any point in time in future without full rework, knowing where I stopped. At the same time I don;t want to dig through the text of generated specs. Having said that, I want to have main architectural decisions explicit and documented.
...
Minimal but sufficient memory:
    - IDEAS.md - anything that can be considered for future work, but not elaborated yet
    - DECISIONS.md - important architectural and product decisions with reasonable rationale
    - PROGRESS.md - keep track of what was done on the high level
    - TASKS.md - next moves to help resume after a break
